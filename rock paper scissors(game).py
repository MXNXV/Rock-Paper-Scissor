...
button1 = tk.Button(text="       ROCK       ",bg="green",command=rock,bd=7,height=1,width=12)
button1.grid(column=0,row=1)
button2 = tk.Button(text="       PAPER      ",bg="yellow",command=paper,bd=7,height=1,width=12)
button2.grid(column=0,row=2)
button3 = tk.Button(text="      SCISSOR     ",bg="orange",command=scissor,bd=7,height=1,width=12)
